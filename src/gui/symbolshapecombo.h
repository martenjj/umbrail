...
#ifndef SYMBOLSHAPECOMBO_H
#define SYMBOLSHAPECOMBO_H

#include <qcombobox.h>


class SymbolShapeCombo : public QComboBox
{
    Q_OBJECT

public:
    explicit SymbolShapeCombo(QWidget *pnt = nullptr);
